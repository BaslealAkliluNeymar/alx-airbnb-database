...
CREATE TABLE Booking (
    ...
    FOREIGN KEY(property_id)  property_id REFERENCES Property(property_id),
...
CREATE TABLE Payment (
    ...
    FOREIGN KEY(booking_id) booking_id REFERENCES Booking(booking_id),
...
CREATE TABLE Message (
    ...
    FOREIGN KEY(user_id) sender_id  REFERENCES User(user_id),
    FOREIGN KEY(user_id) receiver_id  REFERENCES User(user_id),
    FOREIGN KEY(property_id) property_id  REFERENCES Property(property_id),
